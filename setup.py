...
curl.exe -X POST "http://localhost:8000/predict" -F "session_id=test-001" -F "idf_file=@input/US12736584B2.txt"
curl.exe -X POST "http://localhost:8000/predict" -F "session_id=test-001" -F "idf_file=@input/US_20250270010_A1.txt"
