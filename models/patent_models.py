...
class StructuralFeature(BaseModel):
    ...
    feature: str = Field(
        description="A concrete structural component or element of the invention"
    )
    details: str = Field(
        description="Important technical details about the structural feature"
    )
...
class ProceduralFeature(BaseModel):
    ...
    step: str = Field(
        description="A process or operational step performed by the invention"
    )
    details: str = Field(
        description="Important technical details about how the step is performed"
    )
...
class FunctionalFeature(BaseModel):
    ...
    function: str = Field(
        description="A function or capability provided by the invention"
    )
    details: str = Field(
        description="Important technical details about how the function is achieved"
    )


class InventionRepresentation(BaseModel):
    invention_summary: str = Field(
        description="Concise technical summary of the invention"
    )
...
class KeywordSet(BaseModel):
    ...
    primary_keywords: list[str] = Field(
        description="Most important technical terms for this feature"
    )
    synonyms: list[str] = Field(
        description="Technical synonyms and equivalent terminology"
    )
    alternative_terms: list[str] = Field(
        description="Alternative terminology that may appear in patent literature"
    )
